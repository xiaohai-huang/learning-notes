...
[arrow-function in object literal](https://stackoverflow.com/questions/36717376/arrow-function-in-object-literal)

<CodeBlock className="language-js">{arrowFunctionExample1}</CodeBlock>
