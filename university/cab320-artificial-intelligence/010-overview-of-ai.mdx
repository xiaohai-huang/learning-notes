...
- **knowledge representation** to store what it knows or headers;
...
**Solution**: If we cannot the objectives perfectly to the machine, we can create a formulation that the machine is pursuing our objectives, but uncertain what they are.
