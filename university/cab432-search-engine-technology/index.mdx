...
2. There are many different types of data. They extends beyond [structured data](010-information-retrieval.md#structured-data), including unstructured data:
   - text
   - audio
   - video
   - log files
...
[HTML](/docs/Web/HTML/) is a language for marking up text for **presentation**.
